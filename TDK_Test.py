...
def leer_tdk():
    respuesta =""
    # Abrir serial para mandar command parametrización de voltaje en TDK
    ...
    print(f'Conecta el cable de la BK en el puerto DP2')
    ...
    for comando in TDK_DP2:
        ...
        try:
            ...
            ser1.close()
            time.sleep(0.4)
    print(f'Conecta el cable de la BK en el puerto DP3')
    hola = input('pulsa Enter para iniciar el test')
